data='E:\csvdatatwoyear\selectmatch22.csv';
location=readtable('E:\csvdatatwoyear\samedaylocation2.csv');
tnsameday=size(location,1)
...
writetable(buysellmatchedid,'E:\csvdatatwoyear\bridge12.csv');
